...
class CustomColor {
  ...
  static const Color intoPageFontBlack = Color(0xFFFFFFFF);
  ...
  static const Color introPageBackgroudColor = Color(0xff0c4a9a);

  static const Color fontFUck = Color(0xFF245f97);
}
